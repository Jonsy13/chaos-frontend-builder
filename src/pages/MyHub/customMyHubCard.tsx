    ...
    <Paper key={hub.id} elevation={3} className={classes.cardDivChart}>
      <CardContent className={classes.cardContent}>
        ...
        {hub.HubName === 'Chaos Hub' ? (
          <img
            src="./icons/myhub-litmus.svg"
            alt="chaoshub"
            className={classes.litmusImage}
          />
        ) : hub.HubName === 'Kubera Chaos Hub' ? (
          <img
            src="./icons/kubera-chaos-hub.svg"
            alt="chaoshub"
        ...
        {keyValue === hub.id && refreshLoader ? (
          <>
            <Loader />
            <Typography>{t('myhub.refreshing')}</Typography>
          </>
        ) : (
          <>
            <Typography>{t('myhub.lastSync')}</Typography>
