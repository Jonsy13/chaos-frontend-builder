...
const YamlEditor: React.FC<YamlEditorProps> = ({
  ...
  const onEditorChange = (value: string) => {
    ...
    if (stateObject.annotations.length > 0) {
      ...
      nodeStyleError.background = palette.error.main;
      nodeStyleError.color = palette.text.secondary;
    } else {
      setIsValid(true);
      setErrors({
        errorLine: ' ',
      ...
      for (let i = 0; i < nodeStyleErrorList.length; i += 1) {
        ...
        (nodeStyleErrorList[i] as any).style.color = palette.text.hint;
      }
    }
          ...
          >
            <AceEditor
              ...
              onLoad={(editor) => {
                ...
                editor.container.style.background = '#1C2126';
              ...
              onCursorChange={(selection) => {
                ...
                if (
                  ...
                  nodeStyleActive.backgroundColor = '#2DA660';
