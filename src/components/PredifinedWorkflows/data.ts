export default [
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/sock-shop-demo/usingCMDProbe/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/sock-shop-demo/usingCMDProbe/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/sock-shop-demo',
    provider: 'MayaData',
  ...
  },
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/node-cpu-hog/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/node-cpu-hog/workflow_cron.yaml',

    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/node-cpu-hog',
    provider: 'MayaData',
  ...
  },
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/node-memory-hog/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/node-memory-hog/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/node-memory-hog',
    provider: 'MayaData',
  ...
  },
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-cpu-hog/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-cpu-hog/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/pod-cpu-hog',
    provider: 'MayaData',
  ...
  },
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-memory-hog/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-memory-hog/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/pod-memory-hog',
    provider: 'MayaData',
  ...
  },
  {
    ...
    urlToIcon:
      'https://hub.litmuschaos.io/api/icon/1.7.0/generic/pod-delete.png',
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-delete/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/pod-delete/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/pod-delete',
    provider: 'MayaData',
  ...
  },
  {
    ...
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/kube-proxy-all/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/kube-proxy-all/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/kube-proxy-all',
    provider: 'MayaData',
  ...
  },
  {
    ...
    urlToIcon:
      'https://hub.litmuschaos.io/api/icon/1.7.0/generic/pod-delete.png',
    chaosWkfCRDLink:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/namespaced-scope-chaos/workflow.yaml',
    chaosWkfCRDLink_Recur:
      'https://raw.githubusercontent.com/mayadata-io/kubera-chaos-charts/master/workflows/namespaced-scope-chaos/workflow_cron.yaml',
    gitLink:
      'https://github.com/mayadata-io/kubera-chaos-charts/tree/master/workflows/namespaced-scope-chaos',
    provider: 'MayaData',
