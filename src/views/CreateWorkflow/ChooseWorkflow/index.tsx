...
import { InputField, Modal, ButtonOutlined } from 'kubera-ui';
...
const ChooseWorkflow: React.FC<ChooseWorkflowProps> = ({ isEditable }) => {
  ...
  */
  ...
  useEffect(() => {
    ...
    workflow.setWorkflowDetails({
      name:
        workflowData.isBack && parseInt(workflowData.id, 10) === index
          ? workflowData.name
          : timeStampBasedWorkflowName,
      link: workflowsList[index].chaosWkfCRDLink,
      id: workflowsList[index].workflowID,
      yaml: 'none',
          ...
          <div className={classes.modalContainerBody}>
            ...
            <div className={classes.buttons}>
              <div className={classes.cancelButton}>
                <ButtonOutlined onClick={() => handleCancel()} disabled={false}>
