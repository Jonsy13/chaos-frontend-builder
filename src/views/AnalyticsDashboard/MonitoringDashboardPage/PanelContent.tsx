...
const PanelContent: React.FC<PanelResponse> = ({
  ...
  const lineGraph: string[] = Object.values(graph.line).map((elem) =>
    typeof elem === 'string' ? elem : graph.dashboard.lightBlue
  );
  ...
  let seriesData: Array<AreaGrapher> = [
        ...
        <LineAreaGraph
          width={
            (window.innerWidth ||
              ...
              document.body.clientWidth) / 3.15
          }
          height={320}
